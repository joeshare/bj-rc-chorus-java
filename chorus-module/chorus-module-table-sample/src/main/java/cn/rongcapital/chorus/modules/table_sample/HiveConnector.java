...
public class HiveConnector {
    ...
    public static void executeHiveSql(String url, String dbName, String userName,
                                           String hql, String rollbackHql, String queueName,CallBack callBack) throws SQLException {
...
@FunctionalInterface
interface CallBack{
     void call(ResultSet res) throws SQLException;
}