...
CREATE TABLE `data_property` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1701 DEFAULT CHARSET=utf8 COMMENT='数据属性表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `datatype_element` (
  ...
  `status` int(3) NOT NULL DEFAULT '0' COMMENT '状态，0-有效，1-无效',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COMMENT='数据类型字典表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `graph_data_info` (
  ...
  `security_level` varchar(45) DEFAULT NULL COMMENT '安全等级',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=290 DEFAULT CHARSET=utf8 COMMENT='图数据信息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `job` (
  ...
  PRIMARY KEY (`job_id`)
) ENGINE=InnoDB AUTO_INCREMENT=515 DEFAULT CHARSET=utf8 COMMENT='数据任务信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `job_exec_statistic` (
  ...
  `project_id` bigint(20) NOT NULL COMMENT '项目ID',
  `job_name` varchar(50) COLLATE utf8_unicode_ci NOT NULL COMMENT 'XD 任务运行ID(uuid)',
  `job_alias_name` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '任务名（显示）',
  `max_duration` int(8) DEFAULT NULL COMMENT '最大时长',
  `avg_duration` float(10,2) DEFAULT NULL COMMENT '平均时长',
  `completed_num` int(8) DEFAULT NULL COMMENT '执行完成次数',
  `failed_num` int(8) DEFAULT NULL COMMENT '执行失败次数',
  `running_num` int(8) DEFAULT NULL COMMENT '正在执行次数（开始时间与结束时间不在同一天）',
  `current_running_num` int(8) DEFAULT NULL COMMENT '统计时刻正在执行的实例数量',
...
) ENGINE=InnoDB AUTO_INCREMENT=69 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='批量任务执行结果统计表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `job_step` (
  ...
  PRIMARY KEY (`step_id`)
) ENGINE=InnoDB AUTO_INCREMENT=518 DEFAULT CHARSET=utf8 COMMENT='执行步骤信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `project_info` (
  ...
  `project_manager_id` varchar(50) CHARACTER SET latin1 NOT NULL DEFAULT '' COMMENT '项目负责人userid',
...
) ENGINE=InnoDB AUTO_INCREMENT=456 DEFAULT CHARSET=utf8 COMMENT='定时任务表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `stream_exec_statistic` (
  ...
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`),
  UNIQUE KEY `un_pro_job_date` (`project_id`,`date`)
) ENGINE=InnoDB AUTO_INCREMENT=52 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='流式任务执行结果统计表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `task` (
  ...
  `update_time` datetime DEFAULT NULL COMMENT '数据更新时',
  PRIMARY KEY (`task_id`)
) ENGINE=InnoDB AUTO_INCREMENT=770 DEFAULT CHARSET=utf8 COMMENT='执行步骤信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `task_execution_timeout` (
  ...
  `expect_end_time` datetime NOT NULL ON UPDATE CURRENT_TIMESTAMP,
...
) ENGINE=InnoDB AUTO_INCREMENT=116 DEFAULT CHARSET=utf8 COMMENT='Spring XD Module 信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `xd_prop_element` (
  ...
  `update_time` datetime DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=39 DEFAULT CHARSET=utf8 COMMENT='Stream属性信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='平台资源快照表';
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
...
-- Dump completed on 2017-07-13 10:53:53
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='项目资源利用率指标统计天表';
